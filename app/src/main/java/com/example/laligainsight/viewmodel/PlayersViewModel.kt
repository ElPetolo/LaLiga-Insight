...
class PlayersViewModel() : ViewModel() {
    ...
    private val _players = MutableStateFlow<List<FirebasePlayer>>(emptyList())

    // Lista pública de jugadores
    val players: StateFlow<List<FirebasePlayer>> = _players
    ...
    fun loadPlayers() {
        ...
        db.collection("player_images")
            ...
            .addOnSuccessListener { result ->
                ...
                // Convertimos cada documento en FirebasePlayer
